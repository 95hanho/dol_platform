...
export default function DolView() {
  console.log("DolView");
  ...
  return (
    <>
      <Header
        backUse={true}
        title={"<font style='font-size:30px;'>DoL</font>"}
      />
      <Nav />
      <main id="dolView">
          ...
          <ol>
            {categoryList.map((category) => (
              <li key={category.categoryId}>
                <a href="#">
                  <div>
                    <img src={macview_detail_01} alt={category.categoryId} />
                    {/* <img src={category.imgFile} alt={category.categoryId} /> */}
                  </div>
            ...
            <li>
              <a href="#">
                ...
                <div className="dol-cont">
                  <h3>HRD의 이해</h3>
                  <h4>
                    HR에 대한 이해를 바탕으로 조직에서의 HRD의 의미와 여러
                    방법들을 소개하는 DoL입니다.
                  </h4>
                  <p>
                    <strong>김이름</strong> | <span>2023년06월01일</span>
                  </p>
                </div>
              </a>
            </li>
